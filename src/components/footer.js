        ...
        <div className="flex flex-col md:flex-row">
          <div className="flex-1">
            <p className="opacity-100">
              5602 George St., Unit 4, Niagara Falls, Ontario, L2E 3E2 |{" "}
              <a href="tel:905-354-0184">905-354-0184</a> |{" "}
          ...
          <div className="flex flex-1 justify-normal lg:justify-end">
            <p className="opacity-100">
              ...
              <a
                target="_blank"
                href="https://www.termsfeed.com/live/f736d78e-6b52-4a55-9166-96e055ab23d6"
              >
                Privacy Policy
              </a>
            </p>
